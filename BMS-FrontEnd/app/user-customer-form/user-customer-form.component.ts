...
@Component({
  selector: 'app-user-customer-form',
  templateUrl: './user-customer-form.component.html',
  styleUrls: ['./user-customer-form.component.css']
})
export class UserCustomerFormComponent implements OnInit {
  ...
  handleSubmit() {
    ...
    obr.subscribe(
      (data) => this.router.navigateByUrl("/ulogin/uadd")
    );
